...
import profileImg from "../../../../assets/images/auth/profileImg.png";
...
export default function Register() {
  ...
  // state to hold the selected profile image file
 ...
 // function to handle profile image file selection
  ...
  const onSubmit = async(data)=>{
    ...
    // add all keys and values from data object to formData except profileImage
    ...
    toast.success(response?.data?.message || "Account created successfully",{autoClose: 3000});
    ...
    <>
      <Col {...colProps} className=" p-3 rounded-3 formBg text-white">
        ...
        <Form onSubmit={handleSubmit(onSubmit)} className='mx-5 my-3'>
          <AuthHeader subtitle={'welcome to PMS'} title={'Create New Account'}/>  
              ...
              <div className="col-6">
                ...
                <div className='password-wrapper'>
                  <Form.Control  type={showConfirmPassword ? 'text':'password'} placeholder="Confirm New Password"
                    ...
                    validate :value=> value === password ||"Confirm password must match the password."})} />
